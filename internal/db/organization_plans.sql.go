...
WHERE id = $1
RETURNING id, organization_id, plan_id, start_date, end_date
`
...
func (q *Queries) UpdateOrganizationPlan(ctx context.Context, arg UpdateOrganizationPlanParams) (OrganizationPlan, error) {
